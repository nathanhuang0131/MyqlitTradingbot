...
When using the offline package generator (`python -m qlib_tradingbot.Tools.daily_llm_pack --dry-run`),
the generated `feedback_template.csv` is prefilled with governed defaults:
- `bias=Neutral`
- `prob=50`
- `action=Hold`
